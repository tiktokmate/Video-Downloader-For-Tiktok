...
public class DownloadContentAdapter extends RecyclerView.Adapter<DownloadContentAdapter.ContentViewHolder> {
    ...
    public DownloadContentAdapter(Context mContext, List<InstaContent> mContents, DownloadClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ContentViewHolder holder, int position) {
        ...
        if(content.isVideo) {
            Glide.with(mContext)
                    .load(content.url)
                    .placeholder(mContext.getResources().getDrawable(R.drawable.ic_photo_placeholder))
        ...
        else
        {
            Glide.with(mContext)
                    .load(content.url)
                    .placeholder(mContext.getResources().getDrawable(R.drawable.mp3))
                    .into(holder.ivContent);
        }
